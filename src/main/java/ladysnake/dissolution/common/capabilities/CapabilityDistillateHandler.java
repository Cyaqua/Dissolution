...
public class CapabilityDistillateHandler {
    ...
    public static class Storage implements Capability.IStorage<IDistillateHandler> {
        ...
        public void readNBT(Capability<IDistillateHandler> capability, IDistillateHandler instance, EnumFacing side,
            ...
            NBTTagList suctions = compound.getTagList("suctions", 10);
            for (int i = 0; i < suctions.tagCount(); i++) {
                instance.setSuction(DistillateTypes.valueOf(((NBTTagCompound) suctions.get(i)).getString("suctionType")), ((NBTTagCompound) suctions.get(i)).getFloat("suction"));
            }
