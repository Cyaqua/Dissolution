        ...
        switch (debugWanted) {
            ...
            case 4:
                if (!playerIn.world.isRemote) {
                    ...
                    List<Entity> fires = playerIn.world.getEntities(Entity.class, e -> e != null && e.getDistance(playerIn.posX, playerIn.posY, playerIn.posZ) < 20);
            ...
            case 7:
                ...
                playerIn.inventory.addItemStackToInventory(eye);
                break;
            default:
                break;
        }
