...
public abstract class AbstractCandle extends Block implements ITileEntityProvider {
    ...
    {
        boolean flag = ((World) worldIn).isBlockPowered(pos) || ((World) worldIn).isBlockPowered(pos.up());
    ...
    {
        return this.getDefaultState().withProperty(FACING, BlockPistonBase.func_185647_a(pos, placer)).withProperty(POWERED, false);
    }
